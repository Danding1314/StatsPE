...
namespace Fadhel\StatsPE\utils\scoreboard;
...
class Scoreboard
{
     ...
     */
    public function setLine(Player $player, int $line, string $message): void
    {
     ...
     * @param int $sortOrder
     */
    public function create(string $displaySlot, int $sortOrder): void
    {
